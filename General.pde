...
class general{
    ...
    general(int x, int y, int speed){
        ...
        LeftPosition = new PVector(x + 10, y + 20);
        RightPosition = new PVector(x + 40, y + 20);
    ...
    void moveCar(){
        ...
        left.anchor = LeftPosition.copy();
        right.anchor = RightPosition.copy();
        left.update();
        right.update();
    }
    ...
    void displayCar(){
        ...
        stroke(0);
        strokeWeight(2);
        line(LeftPosition.x, LeftPosition.y, left.position.x, left.position.y);
        line(RightPosition.x, RightPosition.y, right.position.x, right.position.y);
